...
data class ItemsRaw(
    ...
    @SerializedName("owner") var owner: OwnerRaw? = OwnerRaw(),
    ...
    @SerializedName("license") var license: LicenseRaw? = LicenseRaw(),
    ...
    @SerializedName("topics") var topics: List<String>? = emptyList(),
